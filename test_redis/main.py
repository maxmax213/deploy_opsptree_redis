...
REDIS_HOST = os.getenv("REDIS_HOST", "redis-replication-master")
...
def main() -> int:
    ...
    try:
        ...
        check(
            ...
            "redis-replication-master Service routes to the current master",
        )
        ...
        replicated = redis.wait(num_replicas=1, timeout=5000)
        check(replicated >= 1, "write was acknowledged by at least one replica")
        return 0
